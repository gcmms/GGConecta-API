...
exports.CommunityModule = CommunityModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([community_post_entity_1.CommunityPost, community_post_like_entity_1.CommunityPostLike, community_post_comment_entity_1.CommunityPostComment])
        ],
